 ...
 * @author anali
 */
@WebServlet(name = "ListarEstufaF", urlPatterns = {"/ListarEstufaF"})
public class ListarEstufaF extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                request.setAttribute("estufas", dao.listarInativosEstufa());
