...
@WebServlet(name = "AlterarStatus", urlPatterns = {"/AlterarStatus"})
public class AlterarStatus extends HttpServlet {
      ...
      protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (dao.alterarstatus(usuarioadm)) {
            ...
            System.out.println("Problemas no Servlet Alterar Status ao enviar formulário! Erro: " + ex.getMessage());
            ex.printStackTrace();
        }
