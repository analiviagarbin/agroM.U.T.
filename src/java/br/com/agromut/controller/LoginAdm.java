...
public class LoginAdm extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!loginAdministrador.equals("") && !senhaAdministrador.equals("")) {
            ...
            Administrador administrador = (Administrador) dao.logarAdm(loginAdministrador, senhaAdministrador);
 
            if (administrador != null) {
                HttpSession sessao = request.getSession(true);
                sessao.setAttribute("administrador", administrador);
                menssage = "Seja bem-vindo(a), " + administrador.getNomeAdministrador() + ".";
