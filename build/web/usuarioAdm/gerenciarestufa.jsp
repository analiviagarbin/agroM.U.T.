                                    ...
                                    <table class="table ">
                                        ...
                                        <tbody>                                                
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#temperatura" type="button">Monitorar</button>
                                                </td>
                                                <td>
                                                    <button class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#umidade" type="button">Monitorar</button>
                                                </td>
                                                <td>
                                                    <a href="AlterarStatus?idestufa=<%/*=estufa.getIdEstufa()*/%>" class="button badge badge-danger">Inativar</a>
                                                </td>
                                                <td align="center">
