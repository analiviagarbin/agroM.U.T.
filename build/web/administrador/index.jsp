                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    Ações disponíveis:
                                    <hr>
                                    <a href="${pageContext.request.contextPath}/ListarUsuarioAdmF"><button class="btn verde-fundo">Solicitações</button></a>
                                    <a href="${pageContext.request.contextPath}/ListarUsuarioAdmT"><button class="btn verde-fundo">Usuários Ativos</button></a>
                                </div>
                            </div> <!-- /.card -->
                        </div> <!-- /.col-lg-8 -->
                    </div>
