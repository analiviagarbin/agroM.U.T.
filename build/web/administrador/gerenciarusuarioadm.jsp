                ...
                <div class="orders">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="box-title">Solicitações </h4>
                                </div>
                                <div class="card-body--">
                                        ...
                                        <table class="table ">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center"><%=usuarioAdm.getNomeUsuario()%></td>
                                                    <td align="center"><%=usuarioAdm.getCpfUsuario()%></td>
                                                    <td align="center"><%=usuarioAdm.getCnpjUsuarioAdm()%></td>
                                                    <td align="center"><%=usuarioAdm.getEmailUsuario()%></td>
                                                    <td align="center"><%=usuarioAdm.getCelularUsuario()%></td>
                                                    <td>
                                                        <a href="AlterarStatus?idusuarioadm=<%=usuarioAdm.getIdUsuarioAdm()%>" class="button badge badge-complete">Ativar</a>
                                                    </td>
                                                </tr>
