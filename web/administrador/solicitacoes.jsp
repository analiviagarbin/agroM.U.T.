...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="${pageContext.request.contextPath}/administrador/assets/images/logoreduzida.png">
                                    ...
                                    <div class="table-stats order-table ov-h">
                                        <table class="table align-middle mb-0 bg-white">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="AtivarAdm?idusuarioadm=<%=usuarioAdm.getIdUsuarioAdm()%>" class="button badge badge-complete">Ativar</a>
                                                </td>
                                            </tr>
